...
from timetable.mixins import ApiErrorsMixin, PublicApiMixin, ApiAuthMixin
...
class GoogleLoginApi(PublicApiMixin, ApiErrorsMixin, APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        login_url = f'http://localhost:8000/auth/login/google/'
        ...
        # api_uri = reverse('auth:login-with-google')
        redirect_uri = f'{domain}/auth/login/google/'
