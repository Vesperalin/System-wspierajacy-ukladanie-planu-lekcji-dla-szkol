...
const ScheduleEditor = () => {
  ...
  const programForClass = useSelector(
    (state) => state.schedule.currentProgramForClass
  );
              ...
              chosenSchedule.map((column, column_index) => {
                return (
                  <div key={column_index}>
                    <p className={style["day-name"]}>
                      {getDayName(column_index)}
                    </p>
